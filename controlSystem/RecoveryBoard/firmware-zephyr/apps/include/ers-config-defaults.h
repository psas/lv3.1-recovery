...
#define SETTING_KEYNAME_HLIMIT_1 STRINGIFY(SETTING_KEYNAME_PREFIX) ## LIMIT_VARNAME_1
#if 1
#define SETTING_KEYNAME_HLIMIT_2 STRINGIFY(SETTING_KEYNAME_PREFIX) ## LIMIT_VARNAME_2
#define SETTING_KEYNAME_HLIMIT_3 STRINGIFY(SETTING_KEYNAME_PREFIX) ## LIMIT_VARNAME_3
#define SETTING_KEYNAME_HLIMIT_4 STRINGIFY(SETTING_KEYNAME_PREFIX) ## LIMIT_VARNAME_4
#endif
