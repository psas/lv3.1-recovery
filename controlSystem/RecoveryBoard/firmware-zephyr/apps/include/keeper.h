...
// Note, not_umb_on is also a digital signal.  Its set and get APIs are defined
// among the ERS summary state parameter APIs, those parameters which appear in
// drogue board and main board CAN status messages.
