...
#define SETTING_KEYNAME_PREFIX setting_
#define SETTING_KEYNAME_HLIMIT_1 SETTING_KEYNAME_PREFIX##LIMIT_VARNAME_1
#if 1
#define SETTING_KEYNAME_HLIMIT_2 SETTING_KEYNAME_PREFIX ## LIMIT_VARNAME_2
#define SETTING_KEYNAME_HLIMIT_3 SETTING_KEYNAME_PREFIX ## LIMIT_VARNAME_3
#define SETTING_KEYNAME_HLIMIT_4 SETTING_KEYNAME_PREFIX ## LIMIT_VARNAME_4
#endif

#define SETTING_KEYNAME_S2_HL1 STRINGIFY(SETTING_KEYNAME_PREFIX) "s2" "_" STRINGIFY(LIMIT_VARNAME_1)
