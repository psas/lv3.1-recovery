...
#define GPIOB_MOTOR_PS              6U
#define GPIOB_MOTOR_FAILA           7U
...
/*UNUSED PORTS GPIO*/
//A
#define LINE_HALL2             PAL_LINE(GPIOA, 1U)
#define LINE_UNUSEDPA11            PAL_LINE(GPIOA, 11U)
#define LINE_UMB_ON             PAL_LINE(GPIOA, 8U)
//B
#define LINE_UNUSEDPB2              PAL_LINE(GPIOB, 2U)
#define LINE_UNUSEDPB3              PAL_LINE(GPIOB, 3U)
#define LINE_DEPLOY1              PAL_LINE(GPIOB, 4U)
#define LINE_DEPLOY2              PAL_LINE(GPIOB, 5U)
#define LINE_MOTOR_PS              PAL_LINE(GPIOB, 6U)
#define LINE_MOTOR_FAILA              PAL_LINE(GPIOB, 7U)
#define LINE_UNUSEDPB8              PAL_LINE(GPIOB, 8U)
#define LINE_UNUSEDPB9              PAL_LINE(GPIOB, 9U)
#define LINE_AD0             PAL_LINE(GPIOB, 10U)
#define LINE_AD1             PAL_LINE(GPIOB, 11U)
 ...
 * GPIOA setup:
 *
 * PA0  - HALL1                  (input floating).
 * PA1  - HALL2                 (output low).
 ...
 * PA6  - ARD_D12, ISO_MAIN          (input pullup).
 * PA7  - ARD_D11, ROCKET_READY          (input pullup).
 * PA8  - UMB_ON                 (input low).
...
#define VAL_GPIOA_MODER             (PIN_MODE_ANALOG(GPIOA_HALL1) |         \
                                     ...
                                     PIN_MODE_OUTPUT(GPIOA_UNUSEDPA4) |         \
                                     PIN_MODE_INPUT(GPIOA_ISO_DROGUE) |     \
                                     PIN_MODE_INPUT(GPIOA_ISO_MAIN) |        \
                                     PIN_MODE_INPUT(GPIOA_ROCKET_READY) |        \
...
#define VAL_GPIOA_OTYPER            (PIN_OTYPE_PUSHPULL(GPIOA_HALL1) |     \
                                     ...
                                     PIN_OTYPE_PUSHPULL(GPIOA_UNUSEDPA4) |     \
...
#define VAL_GPIOA_PUPDR             (PIN_PUPDR_FLOATING(GPIOA_HALL1) |       \
                                     ...
                                     PIN_PUPDR_PULLUP(GPIOA_UNUSEDPA4) |       \
                                     PIN_PUPDR_FLOATING(GPIOA_UNUSEDPA4) |  \
                                     PIN_PUPDR_PULLUP(GPIOA_ISO_MAIN) |      \
                                     PIN_PUPDR_PULLUP(GPIOA_ROCKET_READY) |      \
                                     PIN_PUPDR_PULLUP(GPIOA_UMB_ON) |       \
...
#define VAL_GPIOA_AFRL              (PIN_AFIO_AF(GPIOA_HALL1, 0U) |        \
                                     ...
                                     PIN_AFIO_AF(GPIOA_UNUSEDPA4, 0U) |        \
                                     PIN_AFIO_AF(GPIOA_UNUSEDPA4, 0U) |     \
 ...
 * GPIOB setup:
 *
 * PB0  - ARD_A3, BATT_READ             (analog pullup).
 * PB1  - PIN1, MOTOR_ISENSE               (analog pullup).
 * PB2  - UNUSEDPB2                 (input pullup).
 * PB3  - UNUSEDPB3                 (alternate 0).
 * PB4  - DEPLOY1                 (input pullup).
 * PB5  - DEPLOY2                 (input pullup).
 * PB6  - MOTOR_PS                 (input pullup).
 * PB7  - MOTOR_FAILA                 (input pullup).
 * PB8  - UNUSEDPB8                 (input pullup).
 * PB9  - UNUSEDPB9                 (input pullup).
 * PB10 - AD0                (input pullup).
 * PB11 - AD1                (input pullup).
...
#define VAL_GPIOB_MODER             (PIN_MODE_INPUT(GPIOB_BATT_READ) |         \
                                     ...
                                     PIN_MODE_OUTPUT(GPIOB_MOTOR_PS) |        \
                                     PIN_MODE_OUTPUT(GPIOB_MOTOR_FAILA) |           \
                                     PIN_MODE_OUTPUT(GPIOB_UNUSEDPB8) |        \
                                     PIN_MODE_OUTPUT(GPIOB_UNUSEDPB9) |        \
                                     PIN_MODE_OUTPUT(GPIOB_AD0) |         \
                                     PIN_MODE_OUTPUT(GPIOB_AD1) |          \
...
#define VAL_GPIOB_OTYPER            (PIN_OTYPE_PUSHPULL(GPIOB_BATT_READ) |     \
                                     ...
                                     PIN_OTYPE_PUSHPULL(GPIOB_MOTOR_PS) |    \
                                     PIN_OTYPE_PUSHPULL(GPIOB_MOTOR_FAILA) |       \
...
#define VAL_GPIOB_OSPEEDR           (PIN_OSPEED_HIGH(GPIOB_BATT_READ) |        \
                                     ...
                                     PIN_OSPEED_HIGH(GPIOB_MOTOR_PS) |       \
                                     PIN_OSPEED_HIGH(GPIOB_MOTOR_FAILA) |          \
...
#define VAL_GPIOB_PUPDR             (PIN_PUPDR_FLOATING(GPIOB_BATT_READ) |       \
                                     ...
                                     PIN_PUPDR_PULLUP(GPIOB_DEPLOY1) |       \
                                     PIN_PUPDR_PULLUP(GPIOB_DEPLOY2) |       \
                                     PIN_PUPDR_PULLUP(GPIOB_MOTOR_PS) |      \
                                     PIN_PUPDR_PULLUP(GPIOB_MOTOR_FAILA) |         \
                                     PIN_PUPDR_PULLUP(GPIOB_UNUSEDPB8) |      \
                                     PIN_PUPDR_PULLUP(GPIOB_UNUSEDPB9) |      \
                                     PIN_PUPDR_PULLUP(GPIOB_AD0) |       \
                                     PIN_PUPDR_PULLUP(GPIOB_AD1) |        \
...
#define VAL_GPIOB_ODR               (PIN_ODR_HIGH(GPIOB_BATT_READ) |           \
                                     ...
                                     PIN_ODR_LOW(GPIOB_MOTOR_PS) |          \
                                     PIN_ODR_LOW(GPIOB_MOTOR_FAILA) |             \
...
#define VAL_GPIOB_AFRL              (PIN_AFIO_AF(GPIOB_BATT_READ, 0U) |        \
                                     ...
                                     PIN_AFIO_AF(GPIOB_MOTOR_PS, 0U) |       \
                                     PIN_AFIO_AF(GPIOB_MOTOR_FAILA, 0U))
